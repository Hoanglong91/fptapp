...
export const courseData: Record<string, Record<number, CourseResource[]>> = {
  se: {
    ...
    7: [
      ...
      { id: 5, title: 'SWD392 – Clean Architecture', source: 'GeeksforGeeks', type: 'documents', rating: 4.7, url: 'https://www.geeksforgeeks.org/complete-guide-to-system-design/' },
      // EXE101 – Experiential Entrepreneurship 1
      { id: 6, title: 'EXE101 – Startup & Entrepreneurship', source: 'Coursera', type: 'documents', rating: 4.7, url: 'https://www.coursera.org/learn/wharton-entrepreneurship' },
      { id: 7, title: 'EXE101 – How to Start a Startup', source: 'YouTube', type: 'videos', channel: 'Y Combinator', views: '3.8M', url: 'https://www.youtube.com/watch?v=CBYhVcO4WgI' },
      { id: 8, title: 'EXE101 – Lean Startup Methodology', source: 'YouTube', type: 'videos', channel: 'Slidebean', views: '1.2M', url: 'https://www.youtube.com/watch?v=sobY_PdsSBs' },
      // PMG201c – Project Management
      { id: 9, title: 'PMG201c – Project Management Guide', source: 'Atlassian', type: 'documents', rating: 4.8, url: 'https://www.atlassian.com/work-management/project-management' },
      { id: 10, title: 'PMG201c – PMP Certification Course', source: 'YouTube', type: 'videos', channel: 'Simplilearn', views: '2.9M', url: 'https://www.youtube.com/watch?v=uWPIsaYpY7U' },
      { id: 11, title: 'PMG201c – Scrum & Agile Guide', source: 'Scrum.org', type: 'documents', rating: 4.8, url: 'https://www.scrum.org/resources/what-scrum-module' },
      // SE_COM – Combo Subjects
      { id: 12, title: 'SE Combo – Cloud Computing (AWS)', source: 'AWS Docs', type: 'documents', rating: 4.8, url: 'https://aws.amazon.com/getting-started/' },
      { id: 13, title: 'SE Combo – Docker & Kubernetes', source: 'Docker Docs', type: 'documents', rating: 4.7, url: 'https://docs.docker.com/' },
      { id: 14, title: 'SE Combo – DevOps Full Course', source: 'YouTube', type: 'videos', channel: 'TechWorld with Nana', views: '3.1M', url: 'https://www.youtube.com/watch?v=j5Zsa_eOXeY' },
      { id: 15, title: 'SE Combo – Microservices Architecture', source: 'GeeksforGeeks', type: 'research', citations: 189, url: 'https://www.geeksforgeeks.org/microservices/' },
    ],
    8: [
      ...
      { id: 3, title: 'ITE302c – Computer Ethics Overview', source: 'GeeksforGeeks', type: 'documents', rating: 4.5, url: 'https://www.geeksforgeeks.org/computer-ethics/' },
      // EXE201 – Experiential Entrepreneurship 2
      { id: 4, title: 'EXE201 – Business Model Canvas', source: 'Strategyzer', type: 'documents', rating: 4.8, url: 'https://www.strategyzer.com/library/the-business-model-canvas' },
      { id: 5, title: 'EXE201 – Startup Pitching', source: 'YouTube', type: 'videos', channel: 'Y Combinator', views: '2.4M', url: 'https://www.youtube.com/watch?v=17XZGUX_9iM' },
      { id: 6, title: 'EXE201 – Business Plan Writing', source: 'HubSpot', type: 'documents', rating: 4.7, url: 'https://blog.hubspot.com/marketing/how-to-write-business-plan' },
      // MLN111 – Philosophy of Marxism–Leninism
      { id: 7, title: 'MLN111 – Triết học Mác-Lênin (Tổng quan)', source: 'Wikipedia', type: 'documents', rating: 4.5, url: 'https://vi.wikipedia.org/wiki/Tri%E1%BA%BFt_h%E1%BB%8Dc_M%C3%A1c_%E2%80%93_L%C3%AAnin' },
      { id: 8, title: 'MLN111 – Bài giảng Triết học MLN', source: 'YouTube', type: 'videos', channel: 'Ôn thi đại học', views: '1.5M', url: 'https://www.youtube.com/watch?v=3TE_sr4ma1Y' },
      { id: 9, title: 'MLN111 – Tài liệu ôn tập Triết', source: 'Tài liệu học tập', type: 'documents', rating: 4.6, url: 'https://www.studocu.com/vn/course/dai-hoc-fpt/triet-hoc-mac-lenin/4637340' },
      // MLN122 – Political Economics of Marxism–Leninism
      { id: 10, title: 'MLN122 – Kinh tế Chính trị MLN', source: 'Wikipedia', type: 'documents', rating: 4.5, url: 'https://vi.wikipedia.org/wiki/Kinh_t%E1%BA%BF_ch%C3%ADnh_tr%E1%BB%8B_M%C3%A1c_%E2%80%93_L%C3%AAnin' },
      { id: 11, title: 'MLN122 – Bài giảng KTCT MLN', source: 'YouTube', type: 'videos', channel: 'Ôn thi đại học', views: '890K', url: 'https://www.youtube.com/watch?v=cN8sJkYyFYQ' },
      { id: 12, title: 'MLN122 – Economics Overview', source: 'Khan Academy', type: 'documents', rating: 4.8, url: 'https://www.khanacademy.org/economics-finance-domain/macroeconomics' },
      // PRM393 – Mobile Programming
      { id: 13, title: 'PRM393 – Android Development', source: 'Android Docs', type: 'documents', rating: 4.8, url: 'https://developer.android.com/guide' },
      { id: 14, title: 'PRM393 – React Native Guide', source: 'React Native', type: 'documents', rating: 4.7, url: 'https://reactnative.dev/docs/getting-started' },
      { id: 15, title: 'PRM393 – Android Full Course', source: 'YouTube', type: 'videos', channel: 'freeCodeCamp', views: '3.8M', url: 'https://www.youtube.com/watch?v=fis26HvvDII' },
      { id: 16, title: 'PRM393 – Flutter Full Course', source: 'YouTube', type: 'videos', channel: 'The Net Ninja', views: '2.8M', url: 'https://www.youtube.com/watch?v=1ukSR1GRtMU' },
      { id: 17, title: 'PRM393 – Mobile Dev Roadmap', source: 'Roadmap.sh', type: 'documents', rating: 4.9, url: 'https://roadmap.sh/android' },
      // SE_COM*4
      { id: 18, title: 'SE Combo – Machine Learning', source: 'GeeksforGeeks', type: 'documents', rating: 4.9, url: 'https://www.geeksforgeeks.org/machine-learning/' },
      { id: 19, title: 'SE Combo – ML Course', source: 'YouTube', type: 'videos', channel: 'freeCodeCamp', views: '7.5M', url: 'https://www.youtube.com/watch?v=NWONeJKn6kc' },
      { id: 20, title: 'SE Combo – AI/ML Roadmap', source: 'Roadmap.sh', type: 'documents', rating: 4.8, url: 'https://roadmap.sh/ai-data-scientist' },
    ],
    9: [
      // VNR202 – History of Vietnam Communist Party
      { id: 1, title: 'VNR202 – Lịch sử Đảng CSVN', source: 'Wikipedia', type: 'documents', rating: 4.5, url: 'https://vi.wikipedia.org/wiki/%C4%90%E1%BA%A3ng_C%E1%BB%99ng_s%E1%BA%A3n_Vi%E1%BB%87t_Nam' },
      { id: 2, title: 'VNR202 – Bài giảng Lịch sử Đảng', source: 'YouTube', type: 'videos', channel: 'Ôn thi đại học', views: '2.1M', url: 'https://www.youtube.com/watch?v=kAVQJPmGXhI' },
      { id: 3, title: 'VNR202 – Tài liệu ôn tập', source: 'Studocu', type: 'documents', rating: 4.6, url: 'https://www.studocu.com/vn/course/dai-hoc-fpt/lich-su-dang-cong-san-viet-nam/4637348' },
      // SEP490 – SE Capstone Project
      { id: 4, title: 'SEP490 – Capstone Project Ideas', source: 'GitHub', type: 'documents', rating: 4.9, url: 'https://github.com/florinpop17/app-ideas' },
      { id: 5, title: 'SEP490 – Clean Code Guide', source: 'GitHub', type: 'documents', rating: 4.8, url: 'https://github.com/ryanmcdermott/clean-code-javascript' },
      { id: 6, title: 'SEP490 – Full Stack Project Tutorial', source: 'YouTube', type: 'videos', channel: 'JavaScript Mastery', views: '2.5M', url: 'https://www.youtube.com/watch?v=_oO4Qi5aVZs' },
      { id: 7, title: 'SEP490 – Coding Interview University', source: 'GitHub', type: 'research', citations: 289, url: 'https://github.com/jwasham/coding-interview-university' },
      { id: 8, title: 'SEP490 – Build & Deploy Guide', source: 'Vercel Docs', type: 'documents', rating: 4.8, url: 'https://vercel.com/docs' },
      // MLN131 – Scientific Socialism
      { id: 9, title: 'MLN131 – CNXH Khoa học', source: 'Wikipedia', type: 'documents', rating: 4.5, url: 'https://vi.wikipedia.org/wiki/Ch%E1%BB%A7_ngh%C4%A9a_x%C3%A3_h%E1%BB%99i_khoa_h%E1%BB%8Dc' },
      { id: 10, title: 'MLN131 – Bài giảng CNXH Khoa học', source: 'YouTube', type: 'videos', channel: 'Ôn thi đại học', views: '750K', url: 'https://www.youtube.com/watch?v=NJVDzMVq2Oc' },
      { id: 11, title: 'MLN131 – Tài liệu ôn tập CNXHKH', source: 'Studocu', type: 'documents', rating: 4.6, url: 'https://www.studocu.com/vn/course/dai-hoc-fpt/chu-nghia-xa-hoi-khoa-hoc/4637342' },
      // HCM202 – Ho Chi Minh Ideology
      { id: 12, title: 'HCM202 – Tư tưởng Hồ Chí Minh', source: 'Wikipedia', type: 'documents', rating: 4.5, url: 'https://vi.wikipedia.org/wiki/T%C6%B0_t%C6%B0%E1%BB%9Fng_H%E1%BB%93_Ch%C3%AD_Minh' },
      { id: 13, title: 'HCM202 – Bài giảng TTHCM', source: 'YouTube', type: 'videos', channel: 'Ôn thi đại học', views: '1.3M', url: 'https://www.youtube.com/watch?v=XQaS3P6Tj3A' },
      { id: 14, title: 'HCM202 – Tài liệu ôn tập', source: 'Studocu', type: 'documents', rating: 4.6, url: 'https://www.studocu.com/vn/course/dai-hoc-fpt/tu-tuong-ho-chi-minh/4637346' },
      // Technical Writing & Career
      { id: 15, title: 'Technical Writing Guide', source: 'Google Developers', type: 'documents', rating: 4.8, url: 'https://developers.google.com/tech-writing' },
      { id: 16, title: 'Resume & Portfolio Tips', source: 'Indeed', type: 'documents', rating: 4.7, url: 'https://www.indeed.com/career-advice/resumes-cover-letters' },
      { id: 17, title: 'Technical Interview Prep', source: 'YouTube', type: 'videos', channel: 'NeetCode', views: '1.8M', url: 'https://www.youtube.com/watch?v=aa2nLrBpFxE' },
    ],
  },
  mm: {
    1: [
